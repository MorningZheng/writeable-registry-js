...
Napi::Object Init(Napi::Env env, Napi::Object exports)
{
  ...
  exports.Set(Napi::String::New(env, "readFromKey"), Napi::Function::New(env, ReadFromKey));
  exports.Set(Napi::String::New(env, "deleteFromPath"), Napi::Function::New(env, DeleteFromPath));
